...
$text_columns[''] = __( 'Default', 'organio' );
ct_add_custom_widget(
    array(
        'name' => 'ct_text_editor',
        'title' => esc_html__( 'Case Text Editor', 'organio' ),
        'icon' => 'eicon-text',
        ...
        'params' => array(
            'sections' => array(
                array(
                    'name' => 'editor_section',
                    'label' => esc_html__( 'Text Editor', 'organio' ),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'organio' ),
                        ),
                    ),
                ),
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Text Color Gradient', 'organio' ),
                            'type' => Controls_Manager::COLOR,
                            'default' => '',
                        ),
                        array(
                            'name' => 'gradient_direction',
                            'label' => esc_html__('Gradient Direction', 'organio' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Text Typography', 'organio' ),
                            'control_type' => 'group',
                        ),
                        array(
                        ...
                        array(
                            'name' => 'dropcap',
                            'label' => esc_html__('Dropcap', 'organio' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'no' => 'No',
                                'yes' => 'Yes',
                        ...
                        array(
                            'name' => 'dropcap_style',
                            'label' => esc_html__('Dropcap Style', 'organio' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style1' => 'Style 1',
                                'style2' => 'Style 2',
                        ...
                        array(
                            'name' => 'dropcap_color',
                            'label' => esc_html__( 'Dropcap Text Color', 'organio' ),
                            'type' => Controls_Manager::COLOR,
                            'default' => '',
                            'condition' => [
                                'dropcap' => 'yes',
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Dropcap Background Color', 'organio' ),
                            'type' => Controls_Manager::COLOR,
                            'default' => '',
                            'condition' => [
                                'dropcap' => 'yes',
